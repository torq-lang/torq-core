...
public class TestCompleteTuple {
    ...
    public void testCreate() {
        ...
        map = (Map<?, ?>) nv;
        assertEquals(Map.of(Rec.$LABEL, testLabel.value, Rec.$FIELDS, List.of()), map);
        ...
        assertInstanceOf(Map.class, nv);
        map = (Map<?, ?>) nv;
        assertEquals(Map.of(Rec.$LABEL, testLabel.value, Rec.$FIELDS, List.of(a.value)), map);
        ...
        nv = t.toNativeValue();
        assertInstanceOf(Map.class, nv);
        Map<?, ?> innerNativeValue = Map.of(Rec.$LABEL, testLabel.value, Rec.$FIELDS, List.of(a.value));
        Map<?, ?> outerNativeValue = Map.of(Rec.$LABEL, anotherTestLabel.value, Rec.$FIELDS, List.of(b.value, innerNativeValue));

...
public final class GreaterThanOrEqualToInstr extends AbstractInstr {

    public final CompleteOrIdent a;
    public final CompleteOrIdent b;
    public final Ident x;

    public GreaterThanOrEqualToInstr(CompleteOrIdent a, CompleteOrIdent b, Ident x, SourceSpan sourceSpan) {
        super(sourceSpan);
        this.a = a;
        this.b = b;
        this.x = x;
    ...
    public final <T, R> R accept(KernelVisitor<T, R> visitor, T state) {
        return visitor.visitGreaterThanOrEqualToInstr(this, state);
    }

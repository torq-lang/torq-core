...
public final class PartialObjProcTable<T extends PartialObj> implements ObjProcTable<T> {
    ...
    public final PartialField fieldAt(int index) {
        ...
        return new PartialField(entry.feature, (Proc) entry.objProc);
    }
    ...
    public final PartialObjProcBinding<T> selectAndBind(T target, Feature selector) {
        ...
        return new PartialObjProcBinding<>(target, entries[index].objProc);
    }
    ...
    public static class Builder<T extends PartialObj> {
        ...
        public PartialObjProcTable<T> build() {
            return new PartialObjProcTable<>(entries);
        }
    }

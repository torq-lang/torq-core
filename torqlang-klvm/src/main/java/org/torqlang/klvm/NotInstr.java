...
public final class NotInstr extends AbstractInstr {

    public final CompleteOrIdent a;
    public final Ident x;

    public NotInstr(CompleteOrIdent a, Ident x, SourceSpan sourceSpan) {
        super(sourceSpan);
        this.a = a;
        this.x = x;
    }
    ...
    public final <T, R> R accept(KernelVisitor<T, R> visitor, T state) {
        return visitor.visitNotInstr(this, state);
    }

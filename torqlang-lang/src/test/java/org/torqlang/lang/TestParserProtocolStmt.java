...
public class TestParserProtocolStmt {
    ...
    public void test01() throws Exception {
        ...
        try {
            ...
            assertInstanceOf(ProtocolTypeStruct.class, protocolStmt.body);
            ProtocolTypeStruct protocolTypeStruct = (ProtocolTypeStruct) protocolStmt.body;
            assertEquals(1, protocolTypeStruct.handlers.size());
            assertInstanceOf(ProtocolTypeTellHandler.class, protocolTypeStruct.handlers.get(0));
            ProtocolTypeTellHandler protocolTypeTellHandler = (ProtocolTypeTellHandler) protocolTypeStruct.handlers.get(0);
            assertInstanceOf(StrAsPat.class, protocolTypeTellHandler.pat);
            StrAsPat strAsPat = (StrAsPat) protocolTypeTellHandler.pat;
    ...
    public void test02() throws Exception {
        ...
        try {
            ...
            ProtocolTypeStruct protocolTypeStruct = (ProtocolTypeStruct) protocolStmt.body;
            assertEquals(1, protocolTypeStruct.handlers.size());
            assertInstanceOf(ProtocolTypeAskHandler.class, protocolTypeStruct.handlers.get(0));
            ProtocolTypeAskHandler protocolTypeAskHandler = (ProtocolTypeAskHandler) protocolTypeStruct.handlers.get(0);
            assertInstanceOf(RecPat.class, protocolTypeAskHandler.pat);
            RecPat recPat = (RecPat) protocolTypeAskHandler.pat;

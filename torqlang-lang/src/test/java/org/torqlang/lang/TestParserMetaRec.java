...
public class TestParserMetaRec {
    ...
    public void test01() throws Exception {
        ...
        try {
            ...
            TypeCtor typeCtor = (TypeCtor) typeStmt.body;
            assertEquals(1, typeCtor.typeArgs.size());
            IdentAsType identAsType = asIdentAsType(typeCtor.typeArgs.get(0));
    ...
    public void test09() throws Exception {
        ...
        try {
            ...
            TypeCtor typeCtor = (TypeCtor) typeStmt.body;
            assertEquals(1, typeCtor.typeArgs.size());
            assertEquals("Int32", asIdentAsType(typeCtor.typeArgs.get(0)).ident().name);
            assertNotNull(typeStmt.metaStruct());
            assertInstanceOf(MetaRec.class, typeStmt.metaStruct());
            MetaRec metaRec = (MetaRec) typeStmt.metaStruct();
            assertEquals(2, metaRec.fields().size());

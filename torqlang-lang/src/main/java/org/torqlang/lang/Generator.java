...
import static org.torqlang.klvm.CommonFeatures.$TYPE;
...
public final class Generator implements LangVisitor<LocalTarget, CompleteOrIdent> {
    ...
    public final Instr acceptExpr(StmtOrExpr stmtOrExpr, Ident exprIdent) {
    ...
    public final Instr acceptStmt(StmtOrExpr stmtOrExpr) {
    ...
    private void buildActorInstrs(Ident exprIdent, ActorLang lang, LocalTarget target) {
        ...
        FieldDef ctorDef = new FieldDef($NEW, Ident.$ACTOR_CTOR, endOfActorSpan);
        RecDef actorRecDef = new RecDef(exprIdent.asStr(), List.of(ctorDef), endOfActorSpan);
        childTarget.addInstr(new CreateRecInstr(exprIdent, actorRecDef, endOfActorSpan));

        target.addInstr(childTarget.build());
    }

    private CompleteOrIdent buildBodyInstrs(List<StmtOrExpr> bodyList, LocalTarget target) {
    ...
    private Instr buildCaseInstrs(CompleteOrIdent arg, ValueOrPtn valueOrPtn, List<CompiledPat.ChildPtn> childPtns,
                                  ...
                                  Ident exprIdent, LocalTarget target)
    {
        // BUILD CASE BODY
    ...
    @Override
    public final CompleteOrIdent visitActExpr(ActExpr lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitActorExpr(ActorExpr lang, LocalTarget target) {
        Ident exprIdent = acceptOfferedIdentOrNextSystemVarIdent(target);
    ...
    @Override
    public final CompleteOrIdent visitActorStmt(ActorStmt lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitAndExpr(AndExpr lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitApplyLang(ApplyLang lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitAskStmt(AskStmt lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitBeginLang(BeginLang lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitCaseClause(CaseClause lang, LocalTarget target) {
        lang.body.accept(this, target);
        return null;
    }

    @Override
    public final CompleteOrIdent visitCaseLang(CaseLang lang, LocalTarget target) {
        Ident exprIdent = target.isExprTarget() ? acceptOfferedIdentOrNextSystemVarIdent(target) : null;
    ...
    @Override
    public final CompleteOrIdent visitCatchClause(CatchClause lang, LocalTarget target) {
        lang.body.accept(this, target);
        return null;
    }
    ...
    @Override
    public final CompleteOrIdent visitDotSelectExpr(DotSelectExpr lang, LocalTarget target) {
        Ident exprIdent = acceptOfferedIdentOrNextSystemVarIdent(target);
        LocalTarget childTarget = target.asExprTargetWithNewScope();
    ...
    @Override
    public final CompleteOrIdent visitForStmt(ForStmt lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitFuncExpr(FuncExpr lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitFuncStmt(FuncStmt lang, LocalTarget target) {
        target.addIdentDef(new IdentDef(lang.name.ident));
        ProcDef procDef = buildProcDef(lang.params, Ident.$R, lang.body.list, lang);
    ...
    @Override
    public final CompleteOrIdent visitGroupExpr(GroupExpr lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitIdentAsProtocolType(IdentAsProtocolType lang, LocalTarget target) {
        throw new NeedsImpl();
    }
    ...
    @Override
    public final CompleteOrIdent visitIfLang(IfLang lang, LocalTarget target) {
        Ident exprIdent = target.isExprTarget() ? acceptOfferedIdentOrNextSystemVarIdent(target) : null;
        ...
        for (ImportName in : lang.names) {
            if (in.alias != null) {
                ...
                builder.addValue(Rec.completeTupleBuilder()
                    .addValue(in.name.asStr())
                    .addValue(in.alias.asStr())
                    .build());
            } else {
                target.addIdentDef(new IdentDef(in.name.ident));
                builder.addValue(in.name.asStr());
            }
        }
    ...
    @Override
    public final CompleteOrIdent visitIntersectionProtocolType(IntersectionProtocolType lang, LocalTarget target) {
        throw new NeedsImpl();
    }
    ...
    @Override
    public final CompleteOrIdent visitInitVarDecl(InitVarDecl lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitLocalLang(LocalLang lang, LocalTarget target) {
        Ident exprIdent = acceptOfferedIdentOrNull(target);
    ...
    public final CompleteOrIdent visitModuleStmt(ModuleStmt lang, LocalTarget target) {
        for (StmtOrExpr stmtOrExpr : lang.body) {
            if (stmtOrExpr instanceof ImportStmt importStmt) {
                ...
                FieldDef typeFieldDef = new FieldDef($TYPE, opaqueType, typeStmt);
                RecDef typeRecDef = new RecDef(typeIdent.asStr(), List.of(typeFieldDef), typeStmt);
                target.addInstr(new CreateRecInstr(typeIdent, typeRecDef, typeStmt));
                ...
                OpaqueProtocolType opaqueProtocolType = OpaqueProtocolType.create(protocolStmt);
                FieldDef protocolFieldDef = new FieldDef($TYPE, opaqueProtocolType, protocolStmt);
                RecDef protocolRecDef = new RecDef(protocolIdent.asStr(), List.of(protocolFieldDef), protocolStmt);
                target.addInstr(new CreateRecInstr(protocolIdent, protocolRecDef, protocolStmt));
            } else {
    ...
    @Override
    public final CompleteOrIdent visitNewExpr(NewExpr lang, LocalTarget target) {
        TypeCtor typeCtor = lang.typeCtor;
        Ident exprIdent = acceptOfferedIdentOrNextSystemVarIdent(target);
        LocalTarget childTarget = target.asExprTargetWithNewScope();
        CompleteOrIdent cls = typeCtor.name.ident();
    ...
    @Override
    public final CompleteOrIdent visitOrExpr(OrExpr lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitProcExpr(ProcExpr lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitProcStmt(ProcStmt lang, LocalTarget target) {
        target.addIdentDef(new IdentDef(lang.name.ident));
        ProcDef procDef = buildProcDef(lang.params, null, lang.body.list, lang);
        target.addInstr(new CreateProcInstr(lang.name.ident, procDef, lang));
        return null;
    ...
    @Override
    public final CompleteOrIdent visitProductExpr(ProductExpr lang, LocalTarget target) {
        Ident exprIdent = acceptOfferedIdentOrNextSystemVarIdent(target);
        LocalTarget childTarget = target.asExprTargetWithNewScope();
    ...
    @Override
    public final CompleteOrIdent visitProtocolTypeAskHandler(ProtocolTypeAskHandler lang, LocalTarget target) {
        throw new NeedsImpl();
    }

    @Override
    public final CompleteOrIdent visitProtocolTypeCtor(ProtocolTypeCtor lang, LocalTarget target) {
        throw new NeedsImpl();
    }

    @Override
    public final CompleteOrIdent visitProtocolTypeStreamHandler(ProtocolTypeStreamHandler lang, LocalTarget target) {
        throw new NeedsImpl();
    }

    @Override
    public final CompleteOrIdent visitProtocolTypeStruct(ProtocolTypeStruct lang, LocalTarget target) {
        throw new NeedsImpl();
    }

    @Override
    public final CompleteOrIdent visitProtocolTypeTellHandler(ProtocolTypeTellHandler lang, LocalTarget target) {
        throw new NeedsImpl();
    }

    @Override
    public final CompleteOrIdent visitRecExpr(RecExpr lang, LocalTarget target) {
        Ident exprIdent = acceptOfferedIdentOrNextSystemVarIdent(target);
        LocalTarget childTarget = target.asExprTargetWithNewScope();
    ...
    @Override
    public final CompleteOrIdent visitRelationalExpr(RelationalExpr lang, LocalTarget target) {
        Ident exprIdent = acceptOfferedIdentOrNextSystemVarIdent(target);
        LocalTarget childTarget = target.asExprTargetWithNewScope();
        CompleteOrIdent arg1 = lang.arg1.accept(this, childTarget);
        CompleteOrIdent arg2 = lang.arg2.accept(this, childTarget);
    ...
    @Override
    public final CompleteOrIdent visitReturnStmt(ReturnStmt lang, LocalTarget target) {
    ...
    public final CompleteOrIdent visitSelectAndApplyLang(SelectAndApplyLang lang, LocalTarget target) {
        ...
        while (selectExpr != null) {
            ...
            if ((selectExpr instanceof DotSelectExpr) && (selectExpr.featureExpr instanceof IdentAsExpr identAsExpr)) {
                nestedFeature = identAsExpr.asStr();
            } else {
    ...
    @Override
    public final CompleteOrIdent visitSeqLang(SeqLang lang, LocalTarget target) {
        return buildBodyInstrs(lang.list, target);
    }

    @Override
    public final CompleteOrIdent visitSetCellValueStmt(SetCellValueStmt lang, LocalTarget target) {
        LocalTarget childTarget = target.asStmtTargetWithNewScope();
    ...
    @Override
    public final CompleteOrIdent visitSpawnExpr(SpawnExpr lang, LocalTarget target) {
        Ident exprIdent = target.isExprTarget() ? acceptOfferedIdentOrNextSystemVarIdent(target) : null;
        LocalTarget childTarget = target.asExprTargetWithNewScope();
        List<CompleteOrIdent> ys = new ArrayList<>();
        for (StmtOrExpr arg : lang.args) {
    ...
    @Override
    public final CompleteOrIdent visitSumExpr(SumExpr lang, LocalTarget target) {
        Ident exprIdent = acceptOfferedIdentOrNextSystemVarIdent(target);
        LocalTarget childTarget = target.asExprTargetWithNewScope();
        CompleteOrIdent arg1 = lang.arg1.accept(this, childTarget);
        CompleteOrIdent arg2 = lang.arg2.accept(this, childTarget);
    ...
    @Override
    public final CompleteOrIdent visitTellStmt(TellStmt lang, LocalTarget target) {
        lang.body.accept(this, target);
        return null;
    }

    @Override
    public final CompleteOrIdent visitThrowLang(ThrowLang lang, LocalTarget target) {
        LocalTarget childTarget = target.asExprTargetWithNewScope();
    ...
    @Override
    public final CompleteOrIdent visitTryLang(TryLang lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitTupleExpr(TupleExpr lang, LocalTarget target) {
        Ident exprIdent = acceptOfferedIdentOrNextSystemVarIdent(target);
        LocalTarget childTarget = target.asExprTargetWithNewScope();
    ...
    @Override
    public final CompleteOrIdent visitTypeCtor(TypeCtor lang, LocalTarget target) {
        throw new NeedsImpl();
    }
    ...
    @Override
    public final CompleteOrIdent visitUnaryExpr(UnaryExpr lang, LocalTarget target) {
        Ident exprIdent = acceptOfferedIdentOrNextSystemVarIdent(target);
        LocalTarget childTarget = target.asExprTargetWithNewScope();
        CompleteOrIdent arg = lang.arg.accept(this, childTarget);
        Instr unaryInstr;
    ...
    @Override
    public final CompleteOrIdent visitUnifyStmt(UnifyStmt lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitVarStmt(VarStmt lang, LocalTarget target) {
    ...
    @Override
    public final CompleteOrIdent visitWhileStmt(WhileStmt lang, LocalTarget target) {

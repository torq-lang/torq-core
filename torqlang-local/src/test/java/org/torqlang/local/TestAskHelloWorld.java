...
public class TestAskHelloWorld {
    ...
    public void testHelloWorld() throws Exception {
        ...
        ActorBuilderGenerated g = Actor.builder()
            ...
            .generate();
        String expected = """
            local HelloWorld, $actor_ctor in
                $create_actor_ctor(proc ($r) in // free vars: $respond
                    local $v0, $v4 in
        ...
        assertEquals("FailedValue(error='error'#{'details': {'request': 'goodbye'}, 'message': 'Actor could not match request message with an \\'ask\\' handler.', 'name': 'org.torqlang.lang.AskNotHandledError'})", failedValue.toString());
    }

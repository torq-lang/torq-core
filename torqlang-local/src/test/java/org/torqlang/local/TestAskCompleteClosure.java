...
public class TestAskCompleteClosure {
    ...
    public void test01() throws Exception {
        ...
        ActorBuilderGenerated g = Actor.builder()
            ...
            .generate();
        String expected = """
            local ConcurrentData, $actor_ctor in
                        ...
                        $create_proc(proc ($m) in
                            local $v8 in
                                local $v9 in
                                    ...
                                    $create_rec('error'#{'name': 'org.torqlang.lang.TellNotHandledError', 'message': 'Actor could not match notify message with a \\'tell\\' handler.', 'details': $v9}, $v8)
                                end
                                throw $v8
                            end
                        end, $v7)
        ...
        assertEquals(expected, g.generatedCreateActorRecInstr().toString());
                                ...
                                $create_proc(proc () in // free vars: $m
                                    local $v3 in
                                        local $v4 in
                                            ...
                                            $create_rec('error'#{'name': 'org.torqlang.lang.AskNotHandledError', 'message': 'Actor could not match request message with an \\'ask\\' handler.', 'details': $v4}, $v3)
                                        end
                                        throw $v3
                                    end
                                end, $else)
                        ...
                        $create_proc(proc ($m) in
                            local $v10 in
                                local $v11 in
                                    ...
                                    $create_rec('error'#{'name': 'org.torqlang.lang.TellNotHandledError', 'message': 'Actor could not match notify message with a \\'tell\\' handler.', 'details': $v11}, $v10)
                                end
                                throw $v10
                            end
                        end, $v9)

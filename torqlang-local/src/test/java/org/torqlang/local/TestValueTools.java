...
public class TestValueTools {
    ...
    public void testRecords() {
        ...
        valueType = TypeCtor.arrayOf(Int32Type.SINGLETON);
        expected = Rec.completeTupleBuilder()
            .addValue(Int32.of(0))
            .addValue(Int32.of(1))
            .addValue(Int32.of(2))
    ...
    public void testScalars() {
        ...
        // Create a type that indicates we are converting a LocalDate. ValueTools requires only that the
        // type have a LocalDate constructor.

        String localDateTypeSource = """
            type LocalDate = Obj & {
                func LocalDate(epoch::Int64) -> LocalDate,
            }""";
        TypeStmt localDateTypeStmt = (TypeStmt) new Parser(localDateTypeSource).parse();

        // Convert a string to a LocalDate

        value = ValueTools.toKernelValue("2024-11-03", localDateTypeStmt.body);
        ...
        value = ValueTools.toKernelValue("2024-11-03T08:10:30Z", localDateTypeStmt.body);
        assertEquals(LocalDateMod.createObj(LocalDate.parse("2024-11-03")), value);
    }

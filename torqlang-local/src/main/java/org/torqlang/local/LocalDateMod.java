...
final class LocalDateMod implements KernelModule {
    ...
    private LocalDateMod() {
        namesake = Rec.completeRecBuilder()
            .addField(CommonFeatures.PARSE, (CompleteProc) LocalDateMod::clsParse)
            .build();
    ...
    static final class LocalDateObj implements CompleteObj {
        ...
        private static final CompleteObjProcTable<LocalDateObj> objProcTable = CompleteObjProcTable.<LocalDateObj>builder()
            .build();

...
final class ArrayListMod implements KernelModule {
    ...
    private ArrayListMod() {
        namesake = Rec.completeRecBuilder()
            .addField(CommonFeatures.$NEW, (CompleteProc) ArrayListMod::clsNew)
            .build();
    ...
    static final class ArrayListObj implements PartialObj, ValueIterSource {

        private static final PartialObjProcTable<ArrayListObj> objProcTable = PartialObjProcTable.<ArrayListObj>builder()

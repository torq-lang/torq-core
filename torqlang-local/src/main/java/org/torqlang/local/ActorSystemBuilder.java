...
public final class ActorSystemBuilder {
    ...
    public ActorSystemBuilder addPackage(String qualifier, CompleteRec packageRec) {
        if (packagesByQualifier.containsKey(qualifier)) {
            throw new IllegalArgumentException("Package already exists:" + qualifier);
        }
        packagesByQualifier.put(qualifier, packageRec);
        return this;
    }

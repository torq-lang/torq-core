...
final class HashMapMod implements KernelModule {
    ...
    private HashMapMod() {
        namesake = Rec.completeRecBuilder()
            .addField(CommonFeatures.$NEW, (CompleteProc) HashMapMod::clsNew)
            .build();
    ...
    static final class HashMapObj implements PartialObj, FieldIterSource, ValueIterSource {

        private static final PartialObjProcTable<HashMapObj> objProcTable = PartialObjProcTable.<HashMapObj>builder()
